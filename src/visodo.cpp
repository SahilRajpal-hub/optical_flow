...
double getAbsoluteScale(int frame_id, int sequence_id, double z_cal)	{
  ...
  string line;
  int i = 0;
  ifstream myfile ("/home/sahil/Desktop/2011_09_26/2011_09_26_drive_0059_sync/oxts/data/0000000000.txt");
  double x =0, y=0, z = 0;
...
int main( int argc, char** argv )	{
  ...
  for(int numFrame=2; numFrame < MAX_FRAME; numFrame++)	{
  	sprintf(filename, "/home/sahil/Desktop/2011_09_26/2011_09_26_drive_0059_sync/image_00/data/%010d.png", numFrame);
    //cout << numFrame << endl;
  	Mat currImage= imread(filename, IMREAD_GRAYSCALE);
      if(!currImage.data){ cout<<"data not availiable";return -1;}
